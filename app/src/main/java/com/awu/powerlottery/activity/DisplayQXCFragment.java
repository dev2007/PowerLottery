 ...
 */
public class DisplayQXCFragment extends BaseFragment {
    private static String TAG = "DisplayQXCFragment";

    private ImageText[] ballButtonArray = new ImageText[7];
    public DisplayQXCFragment(){
        super();
        setLayout(R.layout.layout_lottery_qxc, LotteryType.QIXINGCAI);
    }
    ...
    protected void requestOthersOK() {
        ...
        Log.i(TAG, "qxc requestothers ok");
